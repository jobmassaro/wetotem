...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<meta name="description" content="" />
		...
		<!-- custom stylesheet -->
	<link href="<?php echo LNK_CSS ?>style_totem.css" rel="stylesheet" type="text/css" />
	...
	<!-- swf scripts -->
    <script src="<?php echo LNK_SCRIPT ?>swfobject.js"></script>
	<script src="<?php echo LNK_SCRIPT ?>swffit.js"></script>

    </head>

  <body style="background-image: url(../swf/Scontrino.jpg); background-repeat: no-repeat; background-position: center;">
